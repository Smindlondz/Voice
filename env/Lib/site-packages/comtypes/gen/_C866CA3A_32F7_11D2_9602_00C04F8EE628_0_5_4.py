...
__all__ = [
    ...
    'SSSPTRelativeToEnd', 'SGRSTTRule', 'SPEI_RESERVED5',
    'DISPID_SOTDataKey', 'eLEXTYPE_RESERVED8', 'SFTSREngine',
    'SPGRAMMARWORDTYPE', 'ISpeechRecoGrammar',
    'DISPID_SPIAudioStreamPosition', 'SPEI_RESERVED3', 'SPVISEMES',
    'DISPID_SRCERecognitionForOtherContext', 'SPEI_RESERVED6',
    'DISPID_SRCAudioInInterferenceStatus', 'ISpGrammarBuilder',
    'DISPID_SLGetWords', 'SPRULE', 'ISpeechAudioStatus',
    'SpeechPropertyHighConfidenceThreshold', 'DISPID_SVSVisemeId',
    'ISpXMLRecoResult', 'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'SPEI_WORD_BOUNDARY', 'SREAudioLevel', 'DISPID_SPRs_NewEnum',
    'DISPIDSPTSI_ActiveOffset', 'eLEXTYPE_RESERVED9', 'SPAS_CLOSED',
    'DISPID_SBSSeek', 'SPEI_UNDEFINED', 'SpeechPropertyAdaptationOn',
    'DISPID_SpeechPhraseProperty', 'SPPS_LMA', 'SAFT22kHz16BitMono',
    'SRTAutopause', 'ISpRecognizer2', 'SpeechAudioState', 'SPAS_STOP',
    'DISPID_SRSetPropertyString', 'DISPID_SpeechPhoneConverter',
    'DISPID_SVGetProfiles', 'eWORDTYPE_DELETED',
    'DISPID_SPRuleFirstElement', 'SPRS_ACTIVE', 'DISPID_SFSOpen',
    'SpPhoneConverter', 'ISpPhoneConverter', 'SSFMCreateForWrite',
    'DISPID_SpeechRecognizer', 'DISPID_SVSpeakCompleteEvent',
    'DISPID_SpeechMMSysAudio', 'DISPID_SGRs_NewEnum', 'SVSFDefault',
    'SpMMAudioIn', 'DISPID_SAFSetWaveFormatEx', 'SPBO_NONE',
    'DISPID_SVEventInterests', 'IStream', 'DISPID_SLWWord',
    'SAFTCCITT_ALaw_44kHzMono', 'SREAllEvents',
    'SAFTGSM610_11kHzMono', 'SVP_2', 'SAFT44kHz16BitStereo', 'SVP_0',
    'SREPhraseStart', 'SpeechDictationTopicSpelling',
    'SAFT11kHz8BitMono', 'SAFTGSM610_22kHzMono', 'SRSEDone',
    'SpeechRecognizerState', 'DISPID_SVIsUISupported',
    'DISPID_SLPPhoneIds', 'SVEPrivate', 'SREInterference',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SSFMOpenReadWrite',
    'eLEXTYPE_PRIVATE4', 'SPSInterjection', 'DISPID_SGRSTNextState',
    'SpMMAudioEnum', 'DISPID_SPEAudioSizeTime',
    'SPEI_SR_RETAINEDAUDIO', 'SGRSTTDictation', 'tagSPPROPERTYINFO',
    'SP_VISEME_20', 'SRSInactive', 'DISPID_SRCEEnginePrivate',
    'DISPID_SRRGetXMLErrorInfo', 'SAFT16kHz8BitStereo',
    'SECFIgnoreCase', 'ISpeechPhraseProperties', 'SRAORetainAudio',
    'ISpMMSysAudio', 'SAFT24kHz8BitStereo', 'SASClosed',
    'SpeechPropertyNormalConfidenceThreshold', 'SRCS_Disabled',
    'SPRST_ACTIVE_ALWAYS', 'SAFTExtendedAudioFormat', 'SVEAllEvents',
    'DISPID_SpeechRecoResult2', 'DISPID_SpeechAudioBufferInfo',
    'ISpeechAudioFormat', 'SINone', 'SpeechDisplayAttributes',
    'SpPhraseInfoBuilder', 'SDA_Two_Trailing_Spaces',
    'DISPID_SGRAddResource', 'SVF_Stressed', 'SVP_20',
    'eLEXTYPE_PRIVATE20',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet', 'SPEI_VISEME',
    'DISPID_SPIEngineId', 'DISPID_SRGDictationLoad',
    'SpSharedRecognizer', 'SREPrivate', 'DISPID_SVEStreamEnd',
    'SpeechDataKeyLocation', 'DISPID_SRCreateRecoContext',
    ...
    'SAFTADPCM_22kHzMono', 'ISpObjectToken', 'SVSFParseSsml',
    'DISPID_SVRate', 'DISPID_SGRsDynamic', 'eLEXTYPE_PRIVATE12',
    'SP_VISEME_13', 'DISPID_SVGetVoices',
    'DISPID_SpeechXMLRecoResult', 'DISPID_SPCIdToPhone',
    'SPRS_ACTIVE_USER_DELIMITED', 'SpeechSpecialTransitionType',
    'DISPID_SFSClose', 'SpUnCompressedLexicon', 'DISPID_SRIsShared',
    'DISPIDSPRG', 'DISPID_SVResume', 'SPGS_EXCLUSIVE',
    'SPXRO_Alternates_SML', 'SPSFunction', 'SPADAPTATIONRELEVANCE',
    ...
    'SASStop', 'SECHighConfidence', 'LONG_PTR',
    'DISPID_SPEActualConfidence', 'DISPID_SLRemovePronunciation',
    'eLEXTYPE_APP', 'SpShortcut', 'SVSFIsXML', 'DISPID_SRRSpeakAudio',
    'DISPID_SLPsCount', 'SAFT32kHz8BitStereo', 'eLEXTYPE_PRIVATE6',
    'DISPID_SOTs_NewEnum', 'SPINTERFERENCE_TOOLOUD',
    'DISPID_SDKGetBinaryValue', 'SPLEXICONTYPE',
    'DISPID_SVAudioOutputStream', 'ISpeechMMSysAudio',
    'DISPID_SVEBookmark', 'SP_VISEME_4', 'SpeechRecoEvents',
    'SAFTCCITT_ALaw_22kHzStereo', 'SPEVENTSOURCEINFO',
    'DISPID_SPACommit', 'SpeechGrammarWordType', 'DISPID_SBSRead',
    'ISpeechLexiconPronunciations',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SPEVENT',
    'DISPID_SRCEBookmark', 'SRAInterpreter', 'SPTEXTSELECTIONINFO',
    'ISpEventSink', 'DISPID_SRCVoice', '__MIDL_IWinTypes_0009',
    'SVF_Emphasis', 'SPAS_PAUSE', 'SVEVoiceChange',
    'DISPID_SPERequiredConfidence', 'SINoise', 'ISpeechLexiconWords',
    'eLEXTYPE_PRIVATE10', 'ISpeechRecoContext',
    'DISPID_SpeechGrammarRuleStateTransitions', 'eLEXTYPE_RESERVED4',
    'SDTAudio', 'SpeechEngineConfidence', 'ISpeechBaseStream',
    'DISPID_SGRClear', 'DISPID_SOTCDefault',
    'DISPID_SPEAudioTimeOffset', 'SpeechRuleAttributes', 'SITooSlow',
    'SAFT24kHz16BitStereo', 'eLEXTYPE_PRIVATE8', 'SAFT44kHz8BitMono',
    'ISpNotifySource', 'DISPID_SAEventHandle',
    'eLEXTYPE_USER_SHORTCUT', 'ISpeechLexicon',
    'DISPID_SLPPartOfSpeech', 'ISpeechPhraseRule',
    'ISpResourceManager', 'SAFT24kHz16BitMono', 'SAFT44kHz16BitMono',
    'DISPID_SRCEFalseRecognition',
    'DISPID_SpeechGrammarRuleStateTransition',
    'ISpeechPhraseReplacement', 'DISPID_SMSAMMHandle', 'SVP_17',
    'SpCustomStream', 'DISPID_SVAudioOutput', 'SECFIgnoreWidth',
    'DISPID_SGRSTsItem', 'ISpObjectTokenCategory',
    'SpeechAddRemoveWord', 'ISpeechRecoResultTimes',
    'eLEXTYPE_RESERVED6', 'SPWT_DISPLAY',
    'DISPID_SRSetPropertyNumber', 'SPEI_HYPOTHESIS', 'SRCS_Enabled',
    'DISPID_SpeechGrammarRuleState', 'DISPIDSPTSI_ActiveLength',
    'SpInProcRecoContext', 'DISPID_SpeechPhraseRules', 'SVP_10',
    'SAFTADPCM_8kHzMono', 'DISPID_SOTsCount',
    'DISPID_SPRuleEngineConfidence', 'DISPID_SVEWord',
    'DISPID_SADefaultFormat', 'DISPID_SLWsItem', 'SVSFNLPMask',
    'DISPID_SpeechLexiconWords', 'SPEI_SR_BOOKMARK',
    'SAFT11kHz16BitStereo', 'SAFTADPCM_11kHzStereo',
    'SECFEmulateResult', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'SAFTCCITT_ALaw_22kHzMono', 'SAFTADPCM_11kHzMono',
    'DISPID_SABIBufferSize', 'DISPID_SRGCommit', 'SP_VISEME_12',
    'DISPID_SVSInputWordPosition', 'SPEI_SENTENCE_BOUNDARY',
    'SpeechRetainedAudioOptions', 'DISPIDSPTSI', 'SPCS_DISABLED',
    'SDA_One_Trailing_Space', 'DISPID_SGRsFindRule', 'SPBO_AHEAD',
    'DISPID_SPRuleChildren', 'SPAR_Unknown', 'SPSSuppressWord',
    'eLEXTYPE_PRIVATE13', 'SAFT8kHz8BitStereo', 'SPPHRASEREPLACEMENT',
    'DISPID_SpeechRecoResultTimes', 'tagSTATSTG',
    'SAFT22kHz16BitStereo', 'DISPID_SDKSetBinaryValue',
    'ISequentialStream', 'SpVoice', 'DISPID_SPRules_NewEnum',
    'DISPID_SRRTTickCount', 'DISPID_SABufferInfo', 'DISPID_SPRuleId',
    'ISpeechTextSelectionInformation', 'SPSERIALIZEDPHRASE',
    'DISPID_SVSInputSentenceLength', 'DISPID_SRCCreateGrammar',
    'DISPID_SWFEBlockAlign', 'DISPID_SGRsAdd', 'DISPID_SBSWrite',
    'SPWORDPRONOUNCEABLE', 'SpeechAllElements',
    'DISPID_SpeechPhraseBuilder', 'SVSFPersistXML', 'SPSHORTCUTPAIR',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'DISPID_SGRId',
    'SPEI_SOUND_START', 'SpResourceManager',
    'DISPID_SPANumberOfElementsInResult', 'SRERecognition',
    'SVSFUnusedFlags', 'SDTPronunciation', 'SPSMF_UPS',
    'SpeechWordPronounceable', 'DISPID_SRRSetTextFeedback',
    'SAFTCCITT_uLaw_11kHzStereo', 'SREBookmark', 'ISpeechFileStream',
    'SPSModifier', 'SAFTCCITT_ALaw_11kHzStereo', 'DISPID_SRCState',
    'SPFM_NUM_MODES', 'SREPropertyStringChange', 'ISpRecoCategory',
    'DISPID_SRGDictationSetState', 'SAFTGSM610_8kHzMono',
    'DISPID_SGRSTPropertyId', 'ISpeechXMLRecoResult',
    'SAFT11kHz8BitStereo', 'Speech_StreamPos_RealTime',
    'DISPID_SLPsItem', 'STCRemoteServer',
    'DISPID_SpeechPhraseElement', 'SAFT22kHz8BitMono',
    'DISPID_SRCEPhraseStart', 'DISPID_SGRsCommit',
    'DISPID_SDKEnumKeys', 'SSFMOpenForRead', 'SP_VISEME_0',
    'SAFT24kHz8BitMono', 'ISpAudio', 'STCLocalServer',
    'SAFTNoAssignedFormat', 'ISpeechCustomStream',
    'DISPID_SPEPronunciation', 'DISPID_SRRTLength',
    'DISPID_SVESentenceBoundary', 'DISPID_SRGDictationUnload',
    'SPEI_RECOGNITION', 'SBONone', 'SSSPTRelativeToCurrentPosition',
    'eLEXTYPE_VENDORLEXICON', 'SpeechAudioProperties',
    'DISPID_SVDisplayUI', 'SpObjectTokenCategory', 'SpeechWordType',
    'eLEXTYPE_PRIVATE5', 'SpNotifyTranslator',
    'DISPID_SRCVoicePurgeEvent', 'SVSFIsNotXML', 'SP_VISEME_19',
    'ISpeechPhraseRules', 'SP_VISEME_18', 'SPEI_REQUEST_UI',
    'SVSFParseSapi', 'SAFT8kHz16BitStereo', 'DISPID_SGRAddState',
    'SPEI_RECO_STATE_CHANGE', 'eLEXTYPE_PRIVATE7', 'SVEAudioLevel',
    'SPEI_MAX_SR', 'SVF_None', '_SPAUDIOSTATE',
    'DISPID_SpeechPhraseProperties', 'DISPID_SRGCmdSetRuleState',
    'SAFT11kHz16BitMono', 'DISPID_SDKSetLongValue',
    'DISPID_SPPsCount', 'SVP_4', 'SPDKL_DefaultLocation',
    'SITooQuiet', 'eLEXTYPE_PRIVATE3', 'DISPID_SAVolume',
    'SPCT_DICTATION', 'SpMemoryStream', 'SPSHT_EMAIL',
    'SAFTTrueSpeech_8kHz1BitMono', 'DISPID_SPEsItem', 'SP_VISEME_10',
    'DISPID_SRCERecognition', 'SVP_8', 'SVP_19', 'SGPronounciation',
    'DISPID_SDKEnumValues', 'ISpRecoResult',
    'SpeechPropertyComplexResponseSpeed', 'SRTEmulated', 'SRAImport',
    'SPPHRASEPROPERTY', 'DISPID_SRGetPropertyString',
    'ISpeechGrammarRule', 'DISPID_SPIRetainedSizeBytes',
    'DISPID_SGRsCount', 'SpeechLoadOption', 'DISPID_SVEAudioLevel',
    'DISPID_SVSPhonemeId', 'DISPID_SRCEPropertyStringChange',
    'SPRULESTATE', 'DISPID_SVSInputSentencePosition',
    'DISPID_SRCRecognizer', 'SP_VISEME_8', 'SVSFlagsAsync',
    'SP_VISEME_14', 'DISPID_SPPConfidence', 'SPPS_Modifier',
    'SECFDefault', 'ISpeechPhraseAlternate', 'DISPID_SAFType',
    ...
    'SPAUDIOOPTIONS', 'SpeechStreamSeekPositionType', 'SAFTText',
    'SAFT44kHz8BitStereo', 'DISPID_SPCPhoneToId',
    'SpeechCategoryAudioOut', 'ISpStream', 'SpStream',
    'ISpPhoneticAlphabetConverter', 'DISPID_SRSSupportedLanguages',
    'SPINTERFERENCE_TOOSLOW', 'DISPID_SRRDiscardResultInfo',
    'SDTRule', 'DISPID_SPIAudioSizeBytes', 'SDTProperty',
    'SPLOADOPTIONS', 'SDA_No_Trailing_Space', 'DISPID_SPEsCount',
    'DISPID_SPIGrammarId', 'SLODynamic', 'SPRECOCONTEXTSTATUS',
    'SpWaveFormatEx', 'ISpPhrase', 'DISPID_SRRTimes',
    'SPSTREAMFORMATTYPE', 'SPRECORESULTTIMES',
    'SpeechGrammarTagWildcard', 'SP_VISEME_3', 'SpeechVoicePriority',
    'eLEXTYPE_LETTERTOSOUND', 'SPWORDPRONUNCIATIONLIST',
    'DISPID_SMSADeviceId', 'DISPID_SMSSetData', 'SPPS_Verb',
    'SREStateChange', 'DISPID_SVAlertBoundary', 'eLEXTYPE_PRIVATE11',
    'DISPID_SCSBaseStream', 'SRARoot', 'DISPID_SRCEStartStream',
    'SpeechCategoryVoices', 'SAFT48kHz8BitMono', 'DISPID_SOTCategory',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SRCResume', 'SPCS_ENABLED', 'SDKLDefaultLocation',
    'DISPID_SGRsCommitAndSave', 'DISPID_SpeechWaveFormatEx',
    'SECLowConfidence', 'DISPID_SPIReplacements',
    'DISPID_SpeechPhraseReplacements', 'ISpProperties',
    'SGRSTTEpsilon', 'SVEBookmark', 'SPWAVEFORMATTYPE',
    'DISPID_SPIProperties', 'SSTTDictation', 'DISPID_SPRsItem',
    'SP_VISEME_21', 'STCInprocServer',
    'DISPID_SASCurrentSeekPosition', 'SpeechAudioVolume',
    'SRATopLevel', 'SPEI_VOICE_CHANGE', 'DISPID_SWFEBitsPerSample',
    'eLEXTYPE_PRIVATE17', 'DISPID_SpeechGrammarRules',
    'DISPID_SpeechPhraseElements', 'SAFT22kHz8BitStereo',
    'IInternetSecurityManager', 'Speech_Max_Pron_Length',
    'DISPID_SDKCreateKey', 'DISPID_SVGetAudioOutputs',
    'DISPID_SRSNumberOfActiveRules', 'SpeechVisemeType',
    'DISPID_SRCEInterference', 'DISPID_SGRSTWeight',
    'DISPID_SPEs_NewEnum', 'eLEXTYPE_PRIVATE9',
    ...
    'DISPID_SGRSTPropertyValue', 'ISpRecoGrammar',
    'DISPID_SpeechLexiconWord', 'ISpeechResourceLoader',
    'DISPID_SRDisplayUI', 'DISPIDSPTSI_SelectionOffset',
    'DISPID_SRCCmdMaxAlternates', 'SWTDeleted',
    'DISPID_SPISaveToMemory', 'DISPID_SOTCSetId', 'STCAll',
    'DISPID_SpeechRecognizerStatus',
    'DISPID_SVSLastStreamNumberQueued', 'SpStreamFormatConverter',
    'DISPID_SDKDeleteKey', 'SRTExtendableParse', 'ISpRecognizer',
    'SAFTCCITT_uLaw_8kHzStereo', 'SRADefaultToActive',
    'DISPID_SVVolume', 'SpeechGrammarTagDictation', 'SpFileStream',
    'ISpRecoContext', 'DISPID_SRRTOffsetFromStart',
    'SAFT16kHz8BitMono', 'SRERecoOtherContext', 'ISpRecoContext2',
    'DISPID_SPPId', 'DISPID_SRRGetXMLResult', 'SPPS_Function',
    'DISPID_SGRInitialState', 'DISPID_SGRName', 'SPAUDIOSTATE',
    'eLEXTYPE_PRIVATE18', 'SPEI_ACTIVE_CATEGORY_CHANGED', 'SRTReSent',
    'SECFNoSpecialChars', 'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'SPBO_TIME_UNITS', 'SPEI_RESERVED2', 'DISPID_SLPs_NewEnum',
    'DISPID_SMSALineId', 'SPBOOKMARKOPTIONS', 'ISpDataKey',
    'SPXMLRESULTOPTIONS', 'DISPID_SRGRecoContext',
    'DISPID_SOTRemoveStorageFileName', 'DISPID_SGRSRule',
    'DISPID_SOTGetDescription', 'DISPID_SPPParent', 'ISpRecognizer3',
    'DISPID_SPPName', 'SGDisplay', 'DISPID_SpeechPhraseReplacement',
    'SpeechTokenKeyUI', 'SPSHT_OTHER', 'SLOStatic', 'SpeechRunState',
    'DISPID_SPIAudioSizeTime', 'ISpeechObjectToken', 'SFTInput',
    'SPRECOGNIZERSTATUS', 'SPEI_PHRASE_START', 'SVPAlert',
    'DISPID_SpeechPhraseInfo', 'DISPID_SPERetainedSizeBytes',
    'DISPID_SDKGetlongValue', 'SRTSMLTimeout', 'SECNormalConfidence',
    'DISPIDSPTSI_SelectionLength', 'SPCATEGORYTYPE', 'SVSFIsFilename',
    'SpeechStreamFileMode', 'DISPID_SLWLangId', 'SDKLCurrentConfig',
    'DISPID_SPEDisplayAttributes', 'DISPID_SPRsCount', 'SVP_18',
    'SpeechAudioFormatType', 'DISPID_SGRSAddRuleTransition',
    'SPAO_NONE', 'DISPID_SGRSAddWordTransition',
    'SGDSActiveUserDelimited', 'DISPID_SRRecognizer', 'SGSDisabled',
    'SPINTERFERENCE_LATENCY_WARNING', 'SpeechInterference',
    'eLEXTYPE_RESERVED10', 'SPINTERFERENCE',
    'SpPhoneticAlphabetConverter', 'DISPID_SPIStartTime',
    'SPFM_CREATE', 'DISPID_SLGetGenerationChange',
    'SAFT12kHz16BitStereo', 'SDTAll', 'SVSFPurgeBeforeSpeak',
    ...
    'SVEWordBoundary', 'SVEPhoneme', 'SAFT16kHz16BitMono',
    'SPSUnknown', 'DISPID_SRCERequestUI', 'SPDKL_LocalMachine',
    'DISPID_SLAddPronunciation', 'SPEI_SR_PRIVATE',
    'ISpObjectWithToken', 'SPSHORTCUTTYPE', 'ISpeechRecognizer',
    'SP_VISEME_17', 'DISPID_SVEPhoneme', 'SPFILEMODE',
    'DISPID_SASetState', 'DISPID_SOTsItem', '_RemotableHandle',
    '_ISpeechRecoContextEvents', 'SITooFast',
    'SAFTCCITT_uLaw_44kHzStereo', 'eLEXTYPE_RESERVED7',
    'DISPID_SVSCurrentStreamNumber',
    'DISPID_SASCurrentDevicePosition', 'DISPID_SDKSetStringValue',
    'SpeechGrammarState', 'SPAUDIOSTATUS',
    'SAFTCCITT_ALaw_8kHzStereo', 'DISPID_SRGState',
    'DISPID_SLWs_NewEnum', 'DISPID_SRRPhraseInfo',
    'Speech_StreamPos_Asap', 'SpeechCategoryAudioIn', 'SVEViseme',
    'SPWT_LEXICAL', 'DISPID_SLGenerationId',
    'DISPID_SOTMatchesAttributes', 'SVP_21', 'SAFT8kHz16BitMono',
    'SPEI_RESERVED1', 'DISPID_SOTGetAttribute',
    'SAFTADPCM_44kHzStereo', 'UINT_PTR', 'SPEI_MIN_SR', 'SVP_5',
    'SpeechLexiconType', 'SPRST_NUM_STATES', 'DISPID_SRAudioInput',
    'ISpeechGrammarRuleStateTransition', 'SPXRO_SML',
    'DISPID_SGRAttributes', 'DISPID_SRRAlternates', 'SPSNoun',
    'SPAR_Medium', 'SVESentenceBoundary', 'SPCT_COMMAND',
    'SAFTCCITT_uLaw_22kHzStereo', 'SPVOICESTATUS', 'SAFT8kHz8BitMono',
    'DISPID_SpeechPhraseAlternate', 'DISPID_SPRNumberOfElements',
    'SpeechCategoryAppLexicons', 'SPEI_TTS_AUDIO_LEVEL',
    'DISPID_SVEStreamStart', 'DISPID_SLPLangId', 'SGRSTTWord',
    'DISPID_SRRRecoContext', 'IEnumString', 'SRSEIsSpeaking',
    'DISPID_SPPEngineConfidence', 'SpeechRuleState', 'SVP_3',
    'ISpeechPhraseElements', 'SREStreamStart', 'SVP_12',
    'SPSNotOverriden', 'SPEI_SR_AUDIO_LEVEL',
    'DISPID_SpeechPhraseRule', 'SpeechVoiceSpeakFlags',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'DISPID_SOTSetId',
    'DISPID_SOTCId', 'DISPID_SGRSTPropertyName',
    'SAFTCCITT_uLaw_11kHzMono', 'SPEI_ADAPTATION', 'SSTTWildcard',
    'SPBO_PAUSE', 'SVP_11', 'SVEStartInputStream', 'SRSActive',
    'DISPID_SWFEFormatTag', 'DISPID_SGRSTsCount', 'SRESoundEnd',
    'SRERequestUI', 'DISPID_SPRuleName', 'ISpeechMemoryStream',
    'SASRun', 'SPEI_END_SR_STREAM', 'SPVPRI_ALERT', 'SWTAdded',
    'SP_VISEME_15', 'DISPID_SLWsCount', 'ISpeechAudioBufferInfo',
    'SAFTCCITT_uLaw_8kHzMono', 'SpeechMicTraining', 'DISPID_SLPType',
    'DISPID_SOTGetStorageFileName', 'DISPID_SPIEnginePrivateData',
    'SAFTADPCM_8kHzStereo', 'DISPID_SRGCmdLoadFromObject',
    'SGRSTTWildcard', 'SGSEnabled', 'SPVPRI_OVER',
    'DISPID_SPRulesItem', 'SPGS_ENABLED', 'DISPID_SOTId',
    'SWPUnknownWordUnpronounceable',
    'DISPID_SRCERecognizerStateChange', 'SpeechDiscardType',
    'SGDSInactive', 'SRAONone', 'SAFT16kHz16BitStereo',
    'DISPID_SRGCmdLoadFromResource', 'SPEI_PHONEME',
    '_ISpeechVoiceEvents', 'DISPID_SPAsCount', 'DISPID_SPPValue',
    'SpeechAudioFormatGUIDText', 'SpeechEngineProperties',
    'SGSExclusive', 'SPEI_MAX_TTS', 'SPPROPERTYINFO',
    'DISPID_SPEAudioSizeBytes', 'DISPID_SPRuleNumberOfElements',
    'SP_VISEME_2', 'SPPARTOFSPEECH', 'DISPID_SWFESamplesPerSec',
    'DISPID_SVSInputWordLength', 'SPEI_FALSE_RECOGNITION',
    'DISPID_SLGetPronunciations', 'SPPS_RESERVED2',
    'SAFTNonStandardFormat', 'DISPID_SRAudioInputStream',
    'DISPID_SpeechVoiceStatus', 'SRTStandard',
    'DISPID_SPERetainedStreamOffset', 'DISPID_SRRSaveToMemory',
    'SVSFParseAutodetect', 'SPWORDTYPE', 'SpeechVoiceEvents',
    'DISPID_SpeechDataKey', 'SPRS_INACTIVE', 'SPAR_High',
    ...
    'DISPID_SpeechLexiconProns', 'DISPID_SVSLastResult', 'SRADynamic',
    'DISPID_SRRAudio', 'SREAdaptation', 'DISPID_SVWaitUntilDone',
    'SPLO_STATIC', 'DISPID_SRSCurrentStreamPosition', 'SGLexical',
    'SPEI_START_SR_STREAM', 'DISPID_SPRDisplayAttributes',
    'DISPID_SPEAudioStreamOffset', 'DISPID_SPPChildren',
    'SPPS_SuppressWord', 'SAFT48kHz8BitStereo', 'DISPID_SPAsItem',
    'DISPID_SpeechRecoResult', 'SpSharedRecoContext',
    'DISPID_SpeechLexicon', 'SPPS_Noun', 'SPGS_DISABLED',
    'DISPID_SPPs_NewEnum', 'DISPID_SVSpeakStream',
    'DISPID_SGRSTs_NewEnum', 'SVPNormal',
    'DISPID_SLRemovePronunciationByPhoneIds', 'SPWORDPRONUNCIATION',
    'DISPID_SRStatus', 'SDKLCurrentUser',
    'DISPID_SRSCurrentStreamNumber', 'eLEXTYPE_PRIVATE19',
    'DISPID_SRState', 'SPWORDLIST', 'STCInprocHandler',
    'ISpNotifySink', 'DISPID_SWFEChannels', 'ISpeechPhraseAlternates',
    'SPWORD', 'DISPID_SpeechBaseStream', 'SPCT_SUB_COMMAND',
    'SPSEMANTICERRORINFO', 'DISPID_SAFGuid', 'DISPID_SOTRemove',
    'ISpSerializeState', 'DISPID_SVVoice', 'WAVEFORMATEX',
    ...
    'DISPID_SPRFirstElement', 'SRAExport',
    'DISPID_SASFreeBufferSpace', 'ISpPhoneticAlphabetSelection',
    'eLEXTYPE_USER', 'SPSMF_SRGS_SAPIPROPERTIES', 'SpMMAudioOut',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'DISPID_SMSGetData',
    'DISPID_SPPFirstElement', 'DISPID_SAStatus', 'SP_VISEME_5',
    'DISPID_SDKDeleteValue', 'SPEVENTENUM', 'SPFM_OPEN_READONLY',
    'SPINTERFERENCE_NONE', 'SP_VISEME_6', 'SPRST_ACTIVE',
    'DISPID_SOTIsUISupported', 'SpeechTokenIdUserLexicon',
    'tagSPTEXTSELECTIONINFO', 'SPFM_OPEN_READWRITE',
    'SPSEMANTICFORMAT', 'SPEI_INTERFERENCE', 'DISPID_SGRSTType',
    'STSF_LocalAppData', 'SpeechPropertyLowConfidenceThreshold',
    'SPINTERFERENCE_TOOQUIET', 'SPSHT_NotOverriden', 'SPPS_RESERVED3',
    'SDKLLocalMachine', 'SPFM_CREATE_ALWAYS', 'DISPID_SBSFormat',
    'SpInprocRecognizer', 'SVP_6', 'SAFTCCITT_uLaw_22kHzMono',
    'DISPID_SRCEEndStream', 'SpeechRegistryLocalMachineRoot',
    'DISPID_SPPsItem', 'ISpeechGrammarRuleState', 'SRSActiveAlways',
    'ISpeechObjectTokens', 'DISPID_SRGReset',
    ...
    'SpCompressedLexicon', 'SPPHRASERULE', 'SPVPRI_NORMAL',
    'SPAO_RETAIN_AUDIO', 'DISPID_SRRAudioFormat', 'ISpVoice',
    'SVP_16', 'DISPID_SRCEAudioLevel', 'DISPID_SRGId',
    'ISpStreamFormat', 'SpeechCategoryPhoneConverters',
    'eLEXTYPE_MORPHOLOGY', 'DISPID_SRProfile', 'SPWF_SRENGINE',
    ...
    'SPWT_PRONUNCIATION', 'SpObjectToken', 'SPBINARYGRAMMAR',
    ...
    'DISPID_SpeechRecoContext', 'ISpEventSource', 'SPRST_INACTIVE',
    'DISPID_SpeechAudio', 'SpeechRecognitionType',
    'eLEXTYPE_PRIVATE15', 'SREHypothesis', 'SpeechRegistryUserRoot',
    'DISPID_SASState', 'SPSMF_SAPI_PROPERTIES', 'DISPID_SRCBookmark',
    'DISPID_SpeechRecoContextEvents', 'ISpeechPhraseReplacements',
    'DISPID_SRSClsidEngine', 'SPEI_RECO_OTHER_CONTEXT',
    'DISPID_SRCRequestedUIType', 'SPSHORTCUTPAIRLIST', 'SPAS_RUN',
    'ISpeechRecoResult', 'SPEI_TTS_PRIVATE',
    'DISPID_SRGetPropertyNumber', 'ISpNotifyTranslator',
    'SpeechGrammarRuleStateTransitionType', 'SLTUser', 'SGDSActive',
    'ISpeechLexiconWord', 'ISpeechAudio', 'SPPS_NotOverriden',
    ...
    'SPPS_Unknown', 'SpeechTokenContext', 'SVSFVoiceMask',
    'DISPID_SRGSetWordSequenceData', 'SP_VISEME_7', 'DISPID_SVPause',
    'SDTLexicalForm', 'SRESoundStart', 'SpeechUserTraining',
    'SDTDisplayText', 'SAFT48kHz16BitMono', 'Speech_Default_Weight',
    'SPGRAMMARSTATE', 'DISPID_SGRsItem', 'DISPID_SVSpeak',
    'DISPID_SRGRules', 'DISPID_SOTCreateInstance',
    'SpeechVoiceSkipTypeSentence', 'ISpRecoGrammar2', 'SPPHRASE',
    'SpeechPropertyResponseSpeed', 'SWPKnownWordPronounceable',
    'SVSFParseMask', 'SPSVerb', 'SPPS_Noncontent',
    'DISPID_SDKGetStringValue', 'SSFMCreate', 'SpeechTokenValueCLSID',
    'SVP_7', 'SPDKL_CurrentConfig', 'ISpeechPhoneConverter',
    'DISPID_SPIGetDisplayAttributes', 'SpeechFormatType',
    'DISPID_SpeechPhraseAlternates', 'ISpeechPhraseInfo', 'SVP_1',
    'DISPID_SPCLangId', 'SVSFNLPSpeakPunc', 'DISPID_SVGetAudioInputs',
    'SGLexicalNoSpecialChars', 'SpeechRecoContextState', 'SpLexicon',
    'SAFT12kHz8BitMono', 'DISPID_SVPriority', 'SVP_9',
    'DISPID_SPPBRestorePhraseFromMemory', 'ISpeechPhraseElement',
    'DISPID_SRCESoundStart', 'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'DISPID_SpeechAudioStatus', 'SASPause', 'SPEI_MIN_TTS',
    'DISPID_SpeechLexiconPronunciation',
    'DISPID_SREmulateRecognition', 'DISPID_SRGIsPronounceable',
    ...
    'eWORDTYPE_ADDED', 'SAFT12kHz8BitStereo', 'SRSInactiveWithPurge',
    ...
    'ISpeechGrammarRules', 'SPEI_SOUND_END', 'SVP_15',
    'eLEXTYPE_PRIVATE2', 'SVEEndInputStream', 'SPWF_INPUT',
    'SDA_Consume_Leading_Spaces', 'DISPID_SRGetRecognizers',
    'ISpeechDataKey', 'eLEXTYPE_PRIVATE14', 'SPINTERFERENCE_TOOFAST',
    'DISPID_SLPSymbolic', 'SpeechVoiceCategoryTTSRate',
    'DISPID_SRCSetAdaptationData', 'SPLO_DYNAMIC',
    'ISpeechObjectTokenCategory', 'SVPOver', 'SAFTADPCM_44kHzMono',
    'SLTApp', 'SAFT32kHz8BitMono', 'DISPID_SWFEAvgBytesPerSec',
    'DISPID_SOTCGetDataKey', 'DISPID_SLAddPronunciationByPhoneIds',
    'SPSLMA', 'SPSHT_Unknown', 'DISPID_SVSRunningState',
    'DISPID_SRCEPropertyNumberChange', 'SAFTCCITT_ALaw_44kHzStereo',
    'eLEXTYPE_PRIVATE16', 'SWPUnknownWordPronounceable',
    'ISpeechRecoResult2', 'DISPID_SpeechFileStream',
    'DISPID_SRRTStreamTime', 'ISpShortcut', 'DISPID_SRCRetainedAudio',
    'DISPID_SPIRule', 'SPPS_RESERVED4', 'SAFT32kHz16BitMono',
    'SAFT32kHz16BitStereo', 'SVP_13', 'DISPID_SVEViseme',
    'DISPID_SPAStartElementInResult', 'DISPID_SPIElements',
    'DISPID_SpeechObjectTokens', 'SPCT_SLEEP',
    'DISPID_SVEEnginePrivate', 'SGRSTTTextBuffer',
    'DISPID_SPRuleParent', 'SPAR_Low', 'DISPID_SPARecoResult',
    'SPPHRASEELEMENT', 'ISpLexicon', 'SPVPRIORITY', 'SPRECOSTATE',
    'STSF_AppData', 'DISPID_SpeechVoice', 'SPPS_Interjection',
...
_check_version('1.1.14', 1662606437.999286)
